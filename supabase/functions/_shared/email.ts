...
const LOGO_IMG = `<img class="logo-img" src="https://lacco.it/logo-email.png" width="141" height="80" alt="Lacco" style="display:block;height:80px;width:auto;margin:0 auto;position:relative;">`;
const WAVES_IMG = `<img class="wave-img" src="https://lacco.it/waves-email.png" width="520" height="128" alt="" aria-hidden="true" style="position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;border:0;">`;
