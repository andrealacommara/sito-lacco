...
export const SunFilledIcon = ({
  ...
  >
    <g fill="currentColor">
      ...
      <path d="M12 22.96a.969.969 0 01-1-.96v-.08a1 1 0 012 0 1.038 1.038 0 01-1 1.04zM7.14 20.14a1 1 0 011.41 1.41l-.13.13a1 1 0 01-1.41-1.41z" />
    </g>
  </svg>
);
...
export const SearchIcon = (props: IconSvgProps) => (
  ...
  >
    <path
      d="M11.5 21C16.75 21 21 16.75 21 11.5S16.75 2 11.5 2 2 6.25 2 11.5 6.25 21 11.5 21Z"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth="2"
