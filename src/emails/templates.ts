...
// PNGs generated by: npm run generate-email-assets (uses sharp, committed to public/).
...
const LOGO_IMG = `<img class="logo-img" src="${_base}/logo-email.png" width="141" height="80" alt="Lacco" style="display:block;height:80px;width:auto;margin:0 auto;position:relative;">`;
const WAVES_IMG = `<img class="wave-img" src="${_base}/waves-email.png" width="520" height="128" alt="" aria-hidden="true" style="position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;border:0;">`;
...
@media (prefers-color-scheme:dark){
  ...
  .wave-img{filter:invert(1) !important;}
}
...
[data-ogsc] .logo-img{filter:invert(1) !important;}
[data-ogsc] .wave-img{filter:invert(1) !important;}
</style>
</head>
...
<table width="100%" class="email-outer" cellpadding="0" cellspacing="0" style="background:#f4f4f5;padding:32px 16px;">
  <tr><td align="center">
    <table width="100%" class="email-card" bgcolor="#ffffff" style="max-width:520px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e4e4e7;">
      <tr>
        <td class="email-header" bgcolor="#ffffff" style="padding:0;border-bottom:3px solid #F31260;background:#ffffff;">
          <div style="position:relative;overflow:hidden;padding:24px 32px;text-align:center;">
            ${WAVES_IMG}
            ${LOGO_IMG}
          </div>
        </td>
